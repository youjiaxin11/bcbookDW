...
@property (weak, nonatomic) IBOutlet UILabel *lineNineQuestionLabel;
@property (weak, nonatomic) IBOutlet UIImageView *lineNineQuestionImage;
...
@property (weak, nonatomic) IBOutlet UIButton *lineNineMusic1;
@property (weak, nonatomic) IBOutlet UIButton *lineNineMusic2;
@property (weak, nonatomic) IBOutlet UIButton *lineNineMusic3;
