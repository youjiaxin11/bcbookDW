    ...
    [UIView animateWithDuration:1 animations:^{
        for (int i = 0; i < self.photos.count; i++) {
            ...
            if (photo.state == XYZPhotoStateNormal) {
                ...
                photo.alpha = 1;
                photo.frame = CGRectMake(i%3*W+130, i/3*H+225, W, H);//修改双击图片的位置和大小
...
- (void)tapImage2:(UIGestureRecognizer*)sender {
    ...
    [UIView animateWithDuration:0.5 animations:^{
        ...
        if (photo.state == XYZPhotoStateNormal) {
            ...
            if(photo.photoId==1)stringawardcount= [NSString stringWithFormat:@"粽叶：%d",userMybag.award1];
            if(photo.photoId==2) stringawardcount=[ NSString stringWithFormat:@"糯米：%d",userMybag.award2];
            if(photo.photoId==3)stringawardcount=[ NSString stringWithFormat:@"枣：%d",userMybag.award3];
            if(photo.photoId==4)stringawardcount=[ NSString stringWithFormat:@"棕绳：%d",userMybag.award4];
            if(photo.photoId==5)stringawardcount=[ NSString stringWithFormat:@"剪刀：%d",userMybag.award5];
            if(photo.photoId==6)stringawardcount=[ NSString stringWithFormat:@"豆沙：%d",userMybag.award6];
            baward1.hidden=YES;
            baward2.hidden=YES;
            baward3.hidden=YES;
            baward4.hidden=YES;
...
-(void)allcount{
    ...
    stringaward1= [NSString stringWithFormat:@"粽叶：%d",userMybag.award1];
    stringaward2=[ NSString stringWithFormat:@"糯米：%d",userMybag.award2];
    stringaward3=[ NSString stringWithFormat:@"枣：%d",userMybag.award3];
    stringaward4=[ NSString stringWithFormat:@"棕绳：%d",userMybag.award4];
    stringaward5=[ NSString stringWithFormat:@"剪刀：%d",userMybag.award5];
    stringaward6=[ NSString stringWithFormat:@"豆沙：%d",userMybag.award6];
