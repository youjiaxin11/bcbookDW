...
@synthesize url, param, serverData, requestType, control, isSolveFail, isBackup, isLoading,result;
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection {
    if (self.requestType == type_tck) {
        result = [[NSString alloc] initWithData:self.serverData encoding:NSUTF8StringEncoding];
